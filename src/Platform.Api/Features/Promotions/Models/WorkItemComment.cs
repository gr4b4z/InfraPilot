...
/// <summary>
/// Free-text discussion attached to a work item for a specific (product, service, target environment).
/// Keyed the same way as <see cref="WorkItemApproval"/> — <c>(WorkItemKey, Product, Service, TargetEnv)</c>
