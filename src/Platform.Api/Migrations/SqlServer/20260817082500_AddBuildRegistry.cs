        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Branch = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    CommitSha = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BuildId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BuildUrl = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ManifestJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArtifactRef = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ArtifactDigest = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
