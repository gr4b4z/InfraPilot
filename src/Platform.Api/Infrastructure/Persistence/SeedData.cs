...
public static class SeedData
{
    ...
    public static async Task SeedDemoData(PlatformDbContext db)
    {
        ...
        var req3 = new ServiceRequest
        {
            ...
            Status = RequestStatus.Completed,
            InputsJson = """{"record_type":"CNAME","hostname":"api.acme.com","value":"swo-api-gateway.azurefd.net","ttl":3600,"zone":"external"}""",
        ...
        db.ExecutionResults.AddRange(
            ...
            new ExecutionResult
            {
                ...
                Attempt = 1,
                Status = "Completed",
                OutputJson = """{"recordId":"dns-rec-789","fqdn":"api.acme.com"}""",
