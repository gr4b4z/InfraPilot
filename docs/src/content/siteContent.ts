...
executor:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Notifications are useful when humans need to read the event rather than act on it programmatically. The Microsoft Teams and Discord targets post a templated message straight into a channel, so there is no relay function in the middle reformatting the payload. They are created from the **New Notification** button on the Webhooks page and share the same queue, filtering, retries, and delivery history as every other subscription.',
